...
#include    "com_pang_nativeagent_instrument_InstrumentationImpl.h"
 ...
 * com.pang.nativeagent.instrument.InstrumentationImpl class.
...
/*
 * Class:     com_pang_nativeagent_instrument_InstrumentationImpl
